...
namespace CheckersV4.Services
{
    public static class Utils
    {
        ...
        //public static KeyValuePair<int, int> SearchDown(ObservableCollection<PieceVM> pieces)
        //{

        //    int x = (int)GameBusiness.selectedPiece.Piece.PieceLocation.Row + SOUTH;
        //    int y = (int)GameBusiness.selectedPiece.Piece.PieceLocation.Column;

        //    int indexP1 = SearchPiece(pieces, new PieceVM(x, y + EAST));
        //    int indexP2 = SearchPiece(pieces, new PieceVM(x, y + WEST));

        //    return new KeyValuePair<int, int>(indexP1, indexP2);
        //}

        //public static KeyValuePair<int, int> SearchUp(ObservableCollection<PieceVM> pieces)
        //{
        //    int x = (int)GameBusiness.selectedPiece.Piece.PieceLocation.Row + NORTH;
        //    int y = (int)GameBusiness.selectedPiece.Piece.PieceLocation.Column;
        ...
        //private static int SearchPiece(ObservableCollection<PieceVM> pieces, PieceVM checkedPiece)
        //{
        //    int index = 0;
        //    while (pieces.Count > index)
        //    {
        //        if (pieces[index].Equals(checkedPiece))
        //            return index;
        //        ++index;
        //    }
        //    return -1;
        ...
        //private static int SearchTile(ObservableCollection<CellVM> tiles, CellVM tilleVM)
        //{
        //    int index = 0;
        //    while (tiles.Count > index)
        //    {
        //        if (tiles[index].Equals(tilleVM))
        //            return index;
        //        ++index;
        //    }
        //    return -1;
        ...
        public static void RedrawTiles()
        {
            ...
            foreach (var tile in boardVM.Tiles)
            {
                ...
                if (IsOdd(i))
                {
                    ...
                    {
                        tile.Background = Brushes.RosyBrown;
                    }
                }
                else
                {
        ...
        //public static void RemovePhantoms()
        //{
        //    var toRemove = new List<PieceVM>();
        ...
        //    foreach (var phantom in toRemove)
        //    {
        //        boardVM.Pieces.Remove(phantom);
        //    }
        //}
    }
}
